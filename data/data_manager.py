...
class FolderDataManager(object):
    ...
    def _get_dic(self):
        '''
        :return:
            ret: dict, {'awake':['1.jpg','2.jpg'...],'hug':['5.jpg','6.jpg',...]}
            mappings: dict, {'idx_to_class': idx_to_class, 'class_to_idx': class_to_idx}
            classes: ['hug','awake',...]
        '''
    ...
    def _get_arr(self, data_dic):
        '''
        :param data_dic: {'awake':['1.jpg','2.jpg'...],'hug':['5.jpg','6.jpg',...]}
        :return: [{'path': '1.jpg'(path), 'class': 'awake', 'class_idx': class_idx},
        {'path': '2.jpg'(path), 'class': 'awake', 'class_idx': class_idx},...]
        '''
        ret = []
